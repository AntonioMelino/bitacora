...
**Colores en Tailwind:**
Definir la paleta en `tailwind.config.js` bajo `theme.extend.colors`:
```js
colors: {
  primary: '#FF6B35',
  secondary: '#1B4FD8',
...
| 2026-06-24 | feature/trips | CRUD de viajes: entidad Trip actualizada (Description, IsInternational), ITripService, TripService, DTOs CreateTripRequest/UpdateTripRequest/TripResponse, TripsController con endpoints GET/POST/PUT/DELETE (JWT requerido, filtrado por userId), migración AddTripFields aplicada a Supabase |
